...
class Config(BaseModel):
    ...
    def get_api_key(self, model_name: str | None = None) -> str | None:
        """Get API key from config or environment variable (OpenRouter/OpenAI only)."""
        return self.api_key or os.environ.get("API_KEY")

    def get_api_base_url(self, model_name: str | None = None) -> str | None:
        """Get API base URL from config or environment variable (OpenRouter/OpenAI only)."""
